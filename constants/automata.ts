...
//   ],
//   outputs: [
//     { id: 'audio_out', name: 'Audio', type: 'audio', description: 'Generated audio signal from the automaton.' }
//   ],
//   parameters: createParameterDefinitions([

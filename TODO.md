...
[x] транспорт запущен, не обновляется связь если ее добавить или удалить 
[ ] параметры синта должны иметь промежуточные значения 
[ ] удаление копирование блоков через горячие клавиши

[ ] ограничение на соединение портов, которые не подходят друг к другу по типу
Переезд на библиотеку React FLOW для отображения блоков и связей
[x] обработка добавления блока
[x] обработка отображения панели
[x] обработка удаления блока
[x] отображение кастомного содержимого блока, если есть
[x] управление стейтом кастомного содержимого
[x] потеря фокуса у активного Step Seqencer
[x] у Step Seqencer не меняется отображение шагов при клике
[x] в правом меню отображение кнопки не всегда соответствует тому, что в блоке
[x] корректное добавление удаление блоков
[x] у Step Seqencer не работает отображение текущего шага
[ ] панель блока появляется не с первого клика на блок